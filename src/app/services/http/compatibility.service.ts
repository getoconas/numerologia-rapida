...
export class CompatibilityService {
  public compatibilityArray: Array<Compatibility>;

  constructor() { 
    this.compatibilityArray = new Array<Compatibility>;
    this.loadNumbers();
  }
  ...
  private addCompatibility(compatibility: Array<any>) {
    compatibility.forEach(element => {
      this.compatibilityArray.push(element);
    });
  }

  // Retorna listado de compatibilidad
  public getCompatibility(): Array<Compatibility> {
    return this.compatibilityArray;
  }
}
